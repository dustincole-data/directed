...
`,
    ...
    // Very generous timeout: this spawns a whole extra node process that loads
    // jsdom and d3 from disk while the other 12 test files are running. Warm it
    // takes ~2.7s; from a cold cache under that parallel load it took 32s.
  }, 120_000);
});
