...
export function render(svg, data) {
  ...
  // Adapt: scale fluidly with the embedding container (mobile through
  // desktop) instead of staying locked to a fixed pixel box. The viewBox
  // keeps every element -- bars, labels, type -- proportional as it resizes.
  svg.setAttribute(
    "style",
